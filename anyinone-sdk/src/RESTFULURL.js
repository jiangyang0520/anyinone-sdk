...
export default {
  ...
  collection: {
    insert: collName => collection + "/insert/" + collName,
    aggregate: collName => collection + "/aggregate/" + collName,
    update: collName => collection + "/update/" + collName,
    remove: collName => collection + "/remove/" + collName,
  },
  //others
};
